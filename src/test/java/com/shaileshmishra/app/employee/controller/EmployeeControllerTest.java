    ...
    class GetAllEmployees {
        ...
        void shouldReturnEmployeeList() throws Exception {
            List<EmployeeResponseDTO> employees = List.of(
                    new EmployeeResponseDTO("John Doe", "Engineer", "sh1234abcd", new BigDecimal("85000")),
                    new EmployeeResponseDTO("Jane Smith", "Developer", "sh5678efgh", new BigDecimal("95000")));
    ...
    class GetEmployeeById {
        ...
        void shouldReturn404_whenNotFound() throws Exception {
            when(employeeService.getEmployeeById("invalid-id"))
                    .thenThrow(new EmployeeNotFoundException("Employee not found with empId: invalid-id"));
